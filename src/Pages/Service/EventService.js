...
import '; // Update with your actual image path
        ...
        <AppLayouts title={null}>
            <div className="py-8">
                ...
                <section className="mb-8">
                    <img src={eventImage} alt="Event Service" className="w-full h-auto mb-6 rounded-lg shadow-lg" />

                    <p className="text-lg text-gray-700 dark:text-gray-300 mt-4">
                        Event services are essential for creating successful and memorable events, whether it's a small gathering or a large-scale conference. They provide a comprehensive suite of services that can be tailored to meet the specific needs and goals of any event, ensuring everything runs smoothly from start to finish. We are provides various services to help plan, organize, and manage events such as Event Planning and Service, Venue Selection, Audio-Visual and Technical Support, Decor and Design, Entertainment and Activities, Logistics and Transportation, also Marketing and Promotion. Various event we can do :
                    </p>
