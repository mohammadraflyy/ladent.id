                ...
                <>
                    <section id="profile" className="bg-purple-200 bg-opacity-30 p-5 md:px-32 lg:px-64 xl:px-96">
                        ...
                        <div className='text-lg mt-10'>
                            ...
                            <p className="dark:text-white text-black leading-relaxed mt-4">
                        ...
                        <section id="vision" className="mt-8">
                            <h2 className="text-3xl font-bold dark:text-white text-black mb-4">VISION</h2>
                                ...
                                <ul className="list-none space-y-4">
                                    <li className="flex flex-col sm:flex-row items-start space-y-4 sm:space-y-0 sm:space-x-4 p-4 border-b border-gray-200 dark:border-gray-700">
                                        <div className="flex justify-center items-center w-full md:block md:justify-normal md:w-fit">
                                            <SparklesIcon className="md:w-6 md:h-6 w-32 h-32 text-blue-500 dark:text-blue-400" />
                                        </div>
                                        <div className="text-gray-400">
                                            <strong className="block text-xl sm:text-2xl dark:text-white text-black">Becoming Innovation Leaders</strong>
                                    ...
                                    <li className="flex flex-col sm:flex-row items-start space-y-4 sm:space-y-0 sm:space-x-4 p-4 border-b border-gray-200 dark:border-gray-700">
                                        <div className="flex justify-center items-center w-full md:block md:justify-normal md:w-fit">
                                            <BriefcaseIcon className="md:w-6 md:h-6 w-32 h-32 text-green-500 dark:text-green-400" />
                                        </div>
                                        <div className="text-gray-400">
                                            <strong className="block text-xl sm:text-2xl dark:text-white text-black">Developing the Creative Economy</strong>
                                    ...
                                    <li className="flex flex-col sm:flex-row items-start space-y-4 sm:space-y-0 sm:space-x-4 p-4 border-b border-gray-200 dark:border-gray-700">
                                        <div className="flex justify-center items-center w-full md:block md:justify-normal md:w-fit">
                                            <GlobeAltIcon className="md:w-6 md:h-6 w-32 h-32 text-red-500 dark:text-red-400" />
                                        </div>
                                        <div className="text-gray-400">
                                            <strong className="block text-xl sm:text-2xl dark:text-white text-black">Building Cultural Identity</strong>
                                            Strengthen and develop local cultural identity through world-className creative works.
                                        </div>
                                    </li>
                                    <li className="flex flex-col sm:flex-row items-start space-y-4 sm:space-y-0 sm:space-x-4 p-4 border-b border-gray-200 dark:border-gray-700">
                                        <div className="flex justify-center items-center w-full md:block md:justify-normal md:w-fit">
                                            <HeartIcon className="md:w-6 md:h-6 w-32 h-32 text-yellow-500 dark:text-yellow-400" />
                                        </div>
                                        <div className="text-gray-400">
                                            <strong className="block text-xl sm:text-2xl dark:text-white text-black">Improving Quality of Life</strong>
                                    ...
                                    <li className="flex flex-col sm:flex-row items-start space-y-4 sm:space-y-0 sm:space-x-4 p-4">
                                        <div className="flex justify-center items-center w-full md:block md:justify-normal md:w-fit">
                                            <StarIcon className="md:w-6 md:h-6 w-32 h-32 text-purple-200 dark:text-purple-200" />
                                        </div>
                                        <div className="text-gray-400">
                                            <strong className="block text-xl sm:text-2xl dark:text-white text-black">Becoming Global Inspiration</strong>
                    ...
                    <section id="executive-summary" className='p-5 md:px-32 lg:px-64 xl:px-96 dark:bg-gray-900 bg-white py-32'>
                        ...
                        <p className="dark:text-white text-black leading-relaxed mb-4">
                        ...
                        <h2 className="text-2xl font-bold dark:text-white text-black mt-6 mb-4">Digital Transformation</h2>
                        <p className="dark:text-white text-black leading-relaxed mb-4">
                        ...
                        <h2 className="text-2xl font-bold dark:text-white text-black mt-6 mb-4">Rise of Influencer Marketing</h2>
                        <p className="dark:text-white text-black leading-relaxed mb-4">
                        ...
                        <h2 className="text-2xl font-bold dark:text-white text-black mt-6 mb-4">Government Initiatives and Support</h2>
                        <p className="dark:text-white text-black leading-relaxed mb-4">
                        ...
                        <h2 className="text-2xl font-bold dark:text-white text-black mt-6 mb-4">Diversification of Entertainment Offerings</h2>
                        <p className="dark:text-white text-black leading-relaxed mb-4">
                        ...
                        <h2 className="text-2xl font-bold dark:text-white text-black mt-6 mb-4">Increased Investment in Production Quality</h2>
                        <p className="dark:text-white text-black leading-relaxed mb-4">
                        ...
                        <p className="dark:text-white text-black leading-relaxed mt-6">
                    ...
                    <section id="milestones" className='p-5 px-32 bg-purple-200 bg-opacity-30 py-32'>
